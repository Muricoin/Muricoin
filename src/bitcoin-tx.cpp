...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Muricoin Core muricoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  muricoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded muricoin transaction") + "\n" +
              "  muricoin-tx [options] -create [commands]   " + _("Create hex-encoded muricoin transaction") + "\n" +
              "\n";
