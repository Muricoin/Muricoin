...
// Copyright (c) 2014-2015 The Muricoin Core developers
    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Muricoin Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    // Muricoin: load fallback font in case Comic Sans is not availble on the system
    ...
    // Muricoin: Specify Comic Sans as new font.
    QFont newFont("Comic Sans MS", 10);

    // Muricoin: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Muricoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and muricoin: URIs)"));
    ...
    aboutAction = new QAction(platformStyle->TextColorIcon(":/icons/about"), tr("&About Muricoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Muricoin Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(platformStyle->TextColorIcon(":/icons/about_qt"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(platformStyle->TextColorIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Muricoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Muricoin addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Muricoin addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Muricoin Core help message to get a list with possible Muricoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Muricoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Muricoin network", "", count));
}
...
{
    QString strTitle = tr("Muricoin"); // default title
