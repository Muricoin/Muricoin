    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Muricoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Muricoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  muricoin-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Muricoin Core is shutting down...") + "<br /><br />" +
