    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    int titleCopyrightVSpaceMur = 40;
    ...
    QString titleText       = tr("Muricoin Core");
    ...
    QString copyrightTextMur  = QChar(0xA9)+QString(" 2013-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Muricoin Core developers"));
    ...
    pixPaint.setFont(QFont(font, 10*fontFactor));
    pixPaint.drawText(pixmap.width()/devicePixelRatio-titleTextWidth-paddingRight,paddingTop+titleCopyrightVSpaceMur,copyrightTextMur);
