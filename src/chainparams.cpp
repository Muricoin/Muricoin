...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("muricoin.com", "seed.muricoin.com"));
        vSeeds.push_back(CDNSSeedData("multimur.org", "seed.multimur.org"));
        vSeeds.push_back(CDNSSeedData("multimur.org", "seed2.multimur.org"));
        vSeeds.push_back(CDNSSeedData("murr.muricoin.com", "seed.murr.muricoin.com"));
        ...
        //TODO: fix this for muricoin -- plddr
