        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            while (true)
            {
                ...
                *static_cast<CTransaction*>(&wtxNew) = CTransaction(txNew);
                ...
                // Muricoin: Disable free transactions
...
{
    // Muricoin: Round TX bytes up to the next 1,000 bytes
    ...
    if (nFeeNeeded == 0) {
        ...
        // Muricoin: Add an increased fee for each dust output
        nFeeNeeded += GetMuricoinDustFee(tx.vout, minTxFee);
    }
